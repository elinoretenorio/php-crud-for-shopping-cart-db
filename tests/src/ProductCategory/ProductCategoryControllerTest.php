...
use ShoppingCart\ProductCategory\{ ProductCategoryDto, ProductCategoryModel, ProductCategoryController };
...
class ProductCategoryControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("ShoppingCart\ProductCategory\IProductCategoryService");
